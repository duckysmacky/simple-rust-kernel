...
lazy_static::lazy_static! {
    pub static ref WRITER: Mutex<Writer> = Mutex::new(Writer::new(ColorCode::new(Color::White, Color::Black), 0xB8000));
}
...
impl Writer {
    pub fn new(color_code: ColorCode, buffer_address: usize) -> Writer {
        let buffer_ptr = buffer_address as *mut Buffer;
